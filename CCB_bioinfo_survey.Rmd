...
In order to assess the general state of bioinformatic needs at CCB, the heads
of labs were surveyed with a list of questions aimed at ascertaining the
analytical expertise and infrastructure use.
...
* Sarah - Juan on the VSC, the rest currently local but this is expected to change
...
to have an online solution in the end, so we are open to other solutions as well.
